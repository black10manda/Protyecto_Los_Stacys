...
private $permisos;
	...
	public function store(){
		...
		$this->form_validation->set_rules("numero","E-mail ","required|is_unique[clientes.num_documento]|valid_email");
		$this->form_validation->set_rules("pass","Contraseña ","required");
		$this->form_validation->set_rules("passC","Confirmacion de contraseña ","required|matches[pass]'");
	...
	public function update(){
		...
		$this->form_validation->set_rules("tipocliente","Tipo de Cliente","required");
		$this->form_validation->set_rules("tipodocumento","Tipo de Documento","required");
		$this->form_validation->set_rules("numero","Usuario","required".$is_unique);
