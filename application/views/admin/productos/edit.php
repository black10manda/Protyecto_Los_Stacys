                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="img" value="<?php  echo $producto->img;?>" accept="image/*">
                                <img style="height: 60px;" src="<?php echo base_url('assets/uploads/');echo $producto->img; ?>" alt="<?php echo $producto->img; ?>">
                            </div>
