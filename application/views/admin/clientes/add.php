                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/clientes/store" method="POST">
                            ...
                            <div class="form-group <?php echo form_error("pass") != false ? 'has-error':'';?>">
                                <label for="pass">Contraseña:</label>
                                <input type="text" class="form-control" id="pass" name="pass" value="<?php echo set_value("pass");?>">
                                <?php echo form_error("pass","<span class='help-block'>","</span>");?>
                            </div>
                            <div class="form-group <?php echo form_error("passC") != false ? 'has-error':'';?>">
                                <label for="passC">Confirmar Contraseña:</label>
                                <input type="text" class="form-control" id="passC" name="passC" value="<?php echo set_value("passC");?>">
                                <?php echo form_error("passC","<span class='help-block'>","</span>");?>
                            </div>
